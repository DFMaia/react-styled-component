...
> - É preciso instalar um pacote para poder realizar esse projeto.
> - Execute o comando: `npm install --save styled-components`
> ou
> - Execute o comando: `yarn add styled-components`
> - Essa biblioteca ajuda a remover a necessidade de um arquivo `.css`. 
> Para realizar as funções de um arquivo `.css` é possível usar um arquivo `.js` com pequenas funções. 
> - Com isso é possível fazer com que o usuário manipule o design da tela. 
> - Exemplo no código.
> 
